...
import asyncio
from zbnt import ZbntClient, PcapWriter, FrameDetector, TrafficGenerator, Devices, Properties, discover_devices
...
async def main():
	...
	output = PcapWriter("capture.pcap")
	output.register_devices(client)

	client.set_callback(lambda d, m: output.handle_measurement(d, m))
